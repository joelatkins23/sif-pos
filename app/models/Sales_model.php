...
class Sales_model extends CI_Model
{
    ...
    {   
        ...
        // print_r($opay);
        // exit;
        // $this->db->update("payments",array("PaymentStatus"=>"A"), array("id"=>$id));
        // $this->db->update("sales",array("InvoiceStatus"=>"A"), array("id"=>$opay->sale_id));
    ...
    public function syncSalePayments($id)
    {
        ...
        // if ($this->db->update('sales', array('paid' => $paid, 'status' => $status, "InvoiceType"=>"RC", "InvoiceNo"=> "RC SIF".date("Y")."/".$invoice_number,), array('id' => $id))) {
