...
class Datatables
{
    ...
    public function where_in($key_condition, $val = array(), $backtick_protect = TRUE)
    {
    ...
    // public function join_where_in($table_name,$join_con,$filed_name,$where_in){
    //     $this->ci->db->join("tec_sale_items","tec_sale_items");
    //     // $this->ci->db->where_in($filed_name,$where_in);
    // }
