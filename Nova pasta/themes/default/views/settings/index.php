                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       <div class="form-group">
                                            ...
                                            <?= form_input('TaxAccountingBasis', $settings->TaxAccountingBasis, 'class="form-control" id="TaxAccountingBasis" required="required"'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("ProductCompanyTaxID", 'ProductCompanyTaxID'); ?>
                                            <?= form_input('ProductCompanyTaxID', $settings->ProductCompanyTaxID, 'class="form-control" id="ProductCompanyTaxID" required="required"'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("SoftwareValidationNumber", 'SoftwareValidationNumber'); ?>
                                            <?= form_input('SoftwareValidationNumber', $settings->SoftwareValidationNumber, 'class="form-control" id="SoftwareValidationNumber" required="required"'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("ProductID", 'ProductID'); ?>
                                            <?= form_input('ProductID', $settings->ProductID, 'class="form-control" id="ProductID" required="required"'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("ProductVersion", 'ProductVersion'); ?>
                                            <?= form_input('ProductVersion', $settings->ProductVersion, 'class="form-control" id="ProductVersion" required="required"'); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                       <div class="form-group">
                                            ...
                                            <?= form_input('BuildingNumber', $settings->TaxAccountingBasis, 'class="form-control" id="BuildingNumber"'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("HeaderComment", 'HeaderComment'); ?>
                                            <?= form_input('HeaderComment', $settings->HeaderComment, 'class="form-control" id="HeaderComment" '); ?>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <?= lang("tel", 'tel'); ?>
                                    <?= form_input('tel', $settings->Telephone, 'class="form-control" id="tel" required="required"'); ?>
                                </div>
                                <div class="form-group">
