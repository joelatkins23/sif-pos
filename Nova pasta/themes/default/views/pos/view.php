...
<div id="wrapper" >
    ...
    <div  style="al" id="receipt-data">
        <div class="text-center">
            <div id=""><img src="images/header/principal2.png" alt="Logo" width="120" height="86" border="0"> 
    ...
    <p class="print_color"  style="font-size: 12px;  text-align: left">   <?php  echo '<b style="font-size: 12px " class="text-left" >CLIENTE: </b> ';  echo '</tr>'.$customer->name;?>
	  <br>  <?php  echo '<b style="font-size: 12px " class="text-left">NIF: </b> ';echo '</tr>'.$customer->cf1;?>
	  <br>  <?php  echo '<b style="font-size: 12px " class="text-left">Morada: </b> ';echo '</tr>'.$customer->endereco; 
            ...
            <table width="565" class="table table-striped table-condensed">
                ...
                $tax_summary = array();
                foreach ($rows as $row) {
                    echo '<tr><td  style="font-size: 12px " align="left">' . product_name($row->product_name) . '</td>';
                    echo '<td style="font-size: 12px" class="text-right">' . $this->tec->formatNumber($row->quantity) . '</td>';
                    echo '<td style="font-size: 12px" class="text-right">';
		 ...
		 <p style="text-align: center;font-size: 12px;padding-bottom: 10px;">
                            <?php
                                $hash_str = $inv->Hash;
                            ?>
                        <?php echo substr($hash_str, 0,1).substr($hash_str, 10,1).substr($hash_str, 20,1).substr($hash_str, 30,1) ; ?>-Processado por programa validado <span style="text-align: left;font-size: 12px;padding-bottom: 10px;"> nº 230/AGT/2019</span></p> 
            <?php echo '<b style="font-size: 12px " class="text-right">CAIXA:</b>'; ?> <?= $this->session->userdata('username'); ?>
