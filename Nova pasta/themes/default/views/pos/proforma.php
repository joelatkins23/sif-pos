                ...
                <div id="box_left" style="width: 100%;">
                    ...
                    <div id="pos">
                        ...
                        <div class="well well-sm" id="leftdiv">
                            <div id="lefttop" style="margin-bottom: 20px;border-bottom: 1px solid #808080;padding-bottom: 10px;">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-12">
                                        <div class="row">
                                                    ...
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <div class="input-group" style="margin-bottom:3px; width: 100%;">
                                                            ...
                                                            <?php
                                                                foreach ($customers as $customer) {
                                                                    $cus[$customer->id] = $customer->name ;
                                                                    $cus_1 = $customer->name . ' | ' . $customer->phone . ' | ' . $customer->cf2 . ' | ' . $customer->endereco . ' ' . $customer->numero . ' ' . $customer->bairro;
                                            ...
                                            <div class="col-md-6 col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-2 col-xs-12 field-title"><?=lang("address")?> : </div>
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <div class="form-group" style="margin-bottom:3px;">
                                                            <input type="text" name="address" id="address" class="address_input form-control" value="<?php echo $customers[0]->endereco . ' ' . $customers[0]->numero . ' ' . $customers[0]->bairro; ?>"/>
                                                        </div> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12">
                                                <div class="row">
                                                    <div class="col-md-2 col-sm-2 col-xs-12 field-title"><?=lang("phone 2")?> : </div>
                                                    <div class="col-md-10 col-sm-10 col-xs-12">
                                                        <div class="form-group" style="margin-bottom:3px;">
                                                            <input type="text" name="phone2" id="phone2" class="form-control" value="<?php echo $customers[0]->cf2; ?>" />
                                                        </div> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 col-sm-3 col-xs-6" >
                                                    <div class="btn-group-vertical btn-block">
                                                        ...
                                                        id="reset"><i class="fa fa-ban"></i> <span style="display: inline-flex;vertical-align: unset;"><?= lang('cancel'); ?></span> </button><?php } ?>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-sm-3 col-xs-6" >
                                                    <div class="btn-group-vertical btn-block">
                    ...
                    <div class="col-xs-9 for-ft">
                        ...
                        <div class="row for-none-ft">
							...
							<div class="col-xs-6">
                                <div class="form-group">
                                    <?= lang("type", "type"); ?>
                                    <select id="type" class="form-control type select2" style="width:100%;">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <?= form_input('name', '', 'class="form-control input-sm kb-text" id="name"'); ?>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('email', '', 'class="form-control input-sm kb-text" id="email"'); ?>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('phone', '', 'class="form-control input-sm kb-pad" id="phone"'); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('AccountID', '', 'class="form-control input-sm kb-pad" id="AccountID"'); ?>
                        </div>
                    </div>	
                   <div class="col-xs-6">
                        <div class="form-group">
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('numero', '', 'class="form-control input-sm kb-pad" id="numero"'); ?>
                        </div>
                    </div>		
                    ...
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('cidade', '', 'class="form-control input-sm kb-pad" id="cidade"'); ?>
                        </div>
                    </div>		
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('estado', '', 'class="form-control input-sm kb-pad" id="estado"'); ?>
                        </div>
                    </div>		
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('obs1', '', 'class="form-control input-sm kb-pad" id="obs1"'); ?>
                        </div>
                    </div>	
					 <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <?= form_input('Country', '', 'class="form-control input-sm kb-pad" id="Country"'); ?>
                        </div>
                    </div>		
