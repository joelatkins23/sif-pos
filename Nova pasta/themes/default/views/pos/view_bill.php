        ...
        <table align="center">
            <tr>
                ...
                <p>
                                      ...
                                      <td><p><b style="font-size: 20px !important;">TALÃO DE PEDIDO</b></p>
                                     </td>
      <?php echo 
	   $data = date ("Y-m-d");
       ?>
       ...
       ?>
                                ...
                                <table style="margin-bottom: 0; font-size: 11px;" id="billTable" class="table table-striped table-condensed">
                                    <thead>
                                        <tr>
                                            <th width="50%" class="text-center"><?= lang('product'); ?></th>
                                            <th width="15%" class="text-center"><?= lang('Qtd'); ?></th>
                                ...
                                <table border="1" id="totalTable" style="width: 100%; float: right; padding: 5px; color: #000000; background: #FFF;">
                                    <tbody>
                                        <tr>
                                            <td width="50%" style="border-left: 1px solid #ddd; border: 1px solid #333; padding-left:10px; text-align:left; font-weight:normal; font-size: 12px; ">
                                                <?= lang('total_items'); ?>
                                            </td>
                                            <td width="1%" style="text-align:right; padding-right:10px; border: 1px solid #333; font-weight:bold; font-size: 10px;"><span id="count">0</span></td>
                                            <td width="20%" colspan="2" style="padding-left:10px; border: 1px solid #333; text-align:left; font-size: 12px;"><span id="table">0.00</span></td>
                                        </tr>
                                        <tr>
                                            <td style="border-left: 1px solid #ddd;border: 1px solid #333; padding-left:10px; text-align:left; ">&nbsp;</td>
                                            <td style="text-align:right; padding-right:10px;border: 1px solid #333; font-weight:bold;">&nbsp;</td>
                                            <td width="" style="padding-left:10px; text-align:left;border: 1px solid #333; font-weight:normal;">Funcionário</td>
                                            <td width="" style="border-right: 1px solid #ddd; text-align:right; border: 1px solid #333;padding-right:8px; font-weight:bold;"><?= $this->session->userdata('username'); ?></td>
                                        </tr>
                                  </tbody>
                              </table>
