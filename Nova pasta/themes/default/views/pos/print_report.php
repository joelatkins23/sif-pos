    ...
    <body class="with-promo-space22">
        <div class="modal-body" style="width: 80%; margin: 0px auto;">
            <table width="100%" class="stable">
                ...
                if ($suspended_bills) {
                    echo '<hr><h4>' . lang('opened_bills') . '</h4><table class="table table-hovered table-bordered"><thead><tr><th>' . lang('customer') . '</th><th>' . lang('date') . '</th><th>' . lang('reference') . '</th><th>' . lang('amount') . '</th></tr></thead><tbody>';
