<script>
	$(document).ready(function () {
		$('#SLData').dataTable({
            ...
            "aoColumns": [{"mRender":hrld},  null, {"mRender":currencyFormat}, {"mRender":currencyFormat}, {"mRender":currencyFormat}, {"mRender":currencyFormat}, null,  {"bSortable":false, "bSearchable": false}]
		});
