...
class Sales extends MY_Controller {
	...
	function get_sales()
	{
		...
		$this->load->library('datatables');
        $this->datatables->select("id, date, customer_name,  total_tax, total_discount, grand_total, paid, status");
        $this->datatables->from('sales');
