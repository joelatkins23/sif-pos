...
<div id="wrapper" >
    ...
    <div class="no-print">
        <?php if ($message) { ?>
            <div class="alert alert-success">
                <a  href="<?= site_url('pos/cash_sale'); ?>" class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i> Voltar na venda POS</a><button data-dismiss="alert" class="close" type="button">×</button>
    ...
    <div  id="receipt-data">
        <div class="text-center" style="font-size: 12px;">
            <table style="width: 100%">
                <tr>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td width="50%" style="text-align: left; padding-right: 20px;">
                                    <img src="<?php echo $assets; ?>images/header/principal2.png" alt="Logotipo"  width="120" height="86" border="0" />
                                </td>
                            </tr>
                            <tr>
                    ...
                    <td width="50%" style="text-align: left; padding-left: 10%; vertical-align: top; padding-top: 15px;">
                        <p style="text-align: right; color: red !important; padding: 0px;">
                            <?php 
                        ...
                        <p style="font-size: 16px;">
                           <b> 
                            <?php 
                                ...
                                // $invoice_no = substr($invoice_no, 2);
                                // echo $invoice_no;
                                $payment_info = get_row("tec_payments",array("sale_id"=>$inv->id));
                                echo $payment_info['InvoiceNo'];
                            ?>
                           </b>
                        </p>
            ...
            <table style="width: 100%; margin: 25px 0px;">
                <tr style="border-bottom: 1px solid black;">
                    ...
                    <td style="text-align: right;">
                        <span id="print_order">
                            <?php
                                if($this->session->userdata("invoice_status") == "reprint") echo "2V";
                                else echo "ORIGINAL";
                            ?>
                        </span>
                    </td>
                ...
                <tr>
                    <td colspan="3" style="text-align: left;">
                        Recebemos do  <?= lang("dear_sir") ?>  <strong>
                        <?php    echo $customer->name;?>
                        </strong> a quantia de  <strong>
                        <?= $this->tec->formatMoney($inv->grand_total); ?>.
                    </strong> Referente a(s) Factura(s) a baixo:               </td>
                </tr>
            </table>
            <div class="print-spec">
                <table width="527" height="66" class="table table-striped table-condensed" style="margin-top: 5px;">
                    <thead>
                        <tr>
                            <th width="97"  class="print_color text-left"><?=lang('InvoiceNo');?></th>
                            <th width="97"  class="print_color text-right"><?=lang('invoice_amount');?></th>
                           
                            <th width="97"  class="print_color text-right"><?=lang('Valor Pago');?></th>
                            <th width="115" class="print_color text-right"><?=lang('Valor a Pagar');?></th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    $tax_summary = array();
                    echo '<tr>';
                    echo '<td  style="font-size: 10px " align="left">' .$invoice_no . '</td>';
                    echo '<td style="text-align:right;">'.$this->tec->formatMoney($inv->grand_total). '</td>';
                   
                    echo '<td style="text-align:right;">'.$payment->amount. '</td>';
                    echo '<td style="text-align:right;">'.$this->tec->formatMoney($inv->grand_total - $inv->paid). '</td>';
                    echo '</tr>';
                    ...
                    //     echo $this->tec->formatMoney($inv->grand_total). '</td>';
                    ...
                    //     echo '<td style="font-size: 12px" class="text-right">' . $this->tec->formatMoney($row->subtotal) . '</td></tr>'; 
                    // }
                   ...
                   <p style="text-align: left;font-size: 12px;padding-bottom: 10px;">
                    ...
                    <td style="width: 40%; padding-left: 20px; vertical-align: top;">
                        <table style="width: 100%;" class="total_table">
                            <tr> 
                                <th  style=""><?= lang("Total Pago"); ?></th>
                                <th  style="" class="text-right"><?= $this->tec->formatMoney($payment->amount); ?></th>
                            </tr>
                            <tr>
                                <th ><?= lang("tax"); ?></th>
                                <th  class="text-right"><?= $this->tec->formatMoney( $inv->product_tax); ?></th>
                            </tr>
                            <?php
                            if ($inv->order_tax != 0) {
                            ...
                            ?>
                                <tr>
                                    <th >&nbsp;</th>
                                    <th  class="text-right"><?= $rounding; ?>
                                    <?= lang("rounding"); ?></th>
                                </tr>
                                <tr>
                                    <th  style="padding: 0px;"><p class="td-color"><?= lang("grand_total"); ?></p></th>
                                    <th  style="padding: 0px;"><p class="td-color" style="text-align: right;"><?= $this->tec->formatMoney($inv->grand_total); ?></p></th>
                                </tr>
                            <?php
                            } else {
                            ...
                            if ($inv->paid < $round_total) { ?>
                                <tr>
                                    ...
                                    <th class="text-right" style="padding: 0px;"><?= $this->tec->formatMoney($payment->amount); ?></th>
                                </tr>
                                <tr>
            ...
            <span style="text-align: left; font-size: 10px;">Extenso:
            <?php
...
<div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
    ...
    <span class="col-xs-12"><a href="sales" class="btn btn-block btn-primary"><?= lang("back_sale"); ?></a></span>
