                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="payment">
                                    <div class="form-group">
                                        <?= lang("amount", "amount"); ?>
                                        <input type="number" name="amount-paid" type="text" id="amount"
                                        value="<?= ($inv->grand_total - $inv->paid) > 0 ? $this->tec->formatDecimal($inv->grand_total - $inv->paid) : 0; ?>"
                                        class="pa form-control kb-pad amount" required="required" max="<?= ($inv->grand_total - $inv->paid) > 0 ? $this->tec->formatDecimal($inv->grand_total - $inv->paid) : 0; ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <option value="OS"><?= lang("Ordem de Saque"); ?></option>
                                </select>
                            </div>
                        </div>
...
<script type="text/javascript" charset="UTF-8">
    $(document).ready(function () {
        $('#amount').on('input', function () {
            ...
            if ((value !== '')) {
                console.log("asd");
                $(this).val(Math.max(Math.min(value, max_val), 0));
            }
        });
