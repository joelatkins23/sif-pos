                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_dropdown('tax_id', $tax_ids, '', 'class="form-control select2 tip" id="tax_id"  required="required" style="width:100%;"'); ?>
                               ...
                               <!--  <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_input('UnitOfMeasure', "Uni", 'class="form-control tip" id="UnitOfMeasure"  required="required"'); ?>
                                </div>
                                <div class="form-group" id="st">
