        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <a id="sale_print_btn" class="btn btn-primary btn-sm pull-right" style="margin-right:  10px;"><i class="fa fa-print"></i> &nbsp; Lista Vendas</a>
                    
                    <h3 class="box-title"><?= lang('customize_report'); ?></h3>
                    <?= form_open("reports/print_report",'id="print_form" target="_blank" style="display:none;"');?>
                    <?php
                    ...
                    <?= form_open("reports/print_sale",'id="print_sale_form" target="_blank" style="display:none;"');?>
                    <?php
                        $cu[0] = lang("select")." ".lang("customer");
                        foreach($customers as $customer){
                            $cu[$customer->id] = $customer->name;
...
<script type="text/javascript">
    $(function () {
        ...
        $("body").on("click","#sale_print_btn",function(){
            $("#print_sale_form").submit();
        })
