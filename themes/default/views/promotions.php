    ...
    <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
            ...
            <div class="masthead clearfix">
                <div class="inner">
                    <h3 class="text-center"> POS ON</h3>
                </div>
            </div>

            <div class="inner cover">
                <h1 class="cover-heading"> POS ON- Point of Sale </h1>
                ...
                <p class="lead">
                    <a href="http://mactsystem.in" class="btn btn-lg btn-primary">Buy Here</a>
                </p>
            </div>

            <div class="mastfoot">
                <div class="inner">
                    <p>Simple POS by <a href="http://mactsystem.info">Mactsystem</a>.</p>
                </div>
            </div>
