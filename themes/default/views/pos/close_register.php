...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <?= form_open("pos/close_register/" . $user_id, array("id"=>"close_form")); ?>
        <div class="modal-body">
            <table width="100%" class="stable">
                ...
                <tr>
                    <td style="border-bottom: 1px solid #EEE;"><h4>Cartão:</h4></td>
                    <td style="text-align:right;border-bottom: 1px solid #EEE;"><h4>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#transfer_opened_bills").select2({minimumResultsForSearch:6});
        $("body").on("submit","#close_form",function(e){
            e.preventDefault();
            window.localStorage.setItem('note', $("#note").val());
            window.open("<?php echo base_url("pos/print_report"); ?>","_blank");
            document.getElementById("close_form").submit();
        })
    });
</script>
