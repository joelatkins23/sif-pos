        ...
        <div class="text-center" style="font-size: 12px;">
            <table style="width: 100%">
                <tr>
                    ...
                    <td width="50%" style="text-align: left; padding-left: 10%; vertical-align: top; padding-top: 15px;">
                      ...
                      <p class="print_color"  style="font-size: 26px;  text-align: left; ">
                            <?php
                                echo "GUIA TRANSPORTE"
                            ?>
                      </p>
                ...
                <table width="98%" height="45" class="table table-striped table-condensed" style="margin-top: 5px;">
                    ...
                    foreach ($rows as $row) {
                      ...
                      <table style="width: 100%; margin: 25px 0px;" class="no-screen">
                        ...
                        <tr>
                            ...
                            <table width="98%" height="45" class="table table-striped table-condensed" style="margin-top: 5px;">
                                ...
                                <tr class="no-screen-tr">
                                    ...
                                    <th class="print_color text-center" width="70%"><?=lang('description');?></th>
                                    <th class="print_color text-right"width="9%"><?=lang('quantity');?></th>
                                    <th class="print_color text-right"width="15%"></th>
                                    <th class="print_color text-right"width="10%"></th>
                                    <th class="print_color text-right"width="9%"></th>
                                    <th class="print_color text-right" width="10%"></th>
                                </tr>
                            <?php
                        ...
                        echo '<td style="font-size: 10px" width="15%" class="text-right"></td>';
                        echo '<td style="font-size: 10px" width="10%" class="text-right"></td>';
                        echo '<td style="font-size: 10px" width="9%" class="text-right"></td>';

                        echo '<td style="font-size: 10px" width="10%" class="text-right"></td></tr>'; 
                    }
                    $no = 0;
                    if(count($rows)>14) {
                        if(count($rows)>30){
          ...
          if($no != 0)      { ?>
            ...
            <table style="width: 100%; margin-top: 1px;">
                <tr valign="top">
                    <td style="width: 60%; font-size: 10px;"><p style="text-align: left;font-size: 9px;padding-bottom: 1px;"></p>
                   <p style="text-align: left;font-size: 12px;padding-bottom: 1px;">
                            <?php
                                $hash_str = $inv->Hash;
                            ?>
                    ...
                    <td style="width: 40%; padding-left: 20px; vertical-align: top;">
                        <table style="width: 100%; font-size: 12px;" class="total_table">
                            <tr> 
                                <th height="2"  style="font-size: 12px;">&nbsp;</th>
                                <th  style="font-size: 12px;" class="text-right"></th>
                            </tr>
                            <tr>
                                <th height="2" style="font-size: 12px" >&nbsp;</th>
                            ...
                            ?>
                                <tr>
                                    <th height="2" style="font-size: 14px" >&nbsp;</th>
                            ...
                            if ($inv->paid < $round_total) { ?>
                                <tr>
                                    ...
                                    <th class="text-right" style="padding: 0px; font-size: 12px;"></th>
                                </tr>
                                <tr>
                                    <th style="font-size: 12px" >&nbsp;</th>
                                    <th  class="text-right" style="font-size: 12px"></th>
