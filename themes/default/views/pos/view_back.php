...
<div id="wrapper" >
    ...
    <div  style="al" id="receipt-data">
        <div class="text-center">
         <?php include ("empresa.php") ?>
      ...
      </p>      <?php    echo '<b style="font-size: 12px ">CLIENTE: </b> ';  echo '</tr>'.$customer->name;?>
				| <?php  echo '<b style="font-size: 12px ">NIF: </b> ';echo '</tr>'.$customer->numero;?>
				| <?php  echo '<b style="font-size: 12px ">Morada: </b> ';echo '</tr>'.$customer->endereco;
            ...
            <table class="table table-striped table-condensed">
                <thead>
                    <tr>
                        ...
                        <th class="text-right col-xs-1"><?=lang('quantity');?></th>
                        <th class="text-right col-xs-1"><?=lang('price');?></th>
						
                        <th class="text-right col-xs-1"><?=lang('subtotal');?></th>
                    </tr>
                </thead>
                <tbody>
                <?php
                ...
                <tr>
                    ...
                    <th colspan="2" class="text-right"><?= $this->tec->formatMoney( $inv->product_tax); ?></th>
                </tr>
                <?php
                if ($inv->order_tax != 0) {
            ...
            ?>
            <?php echo '<b style="font-size: 12px ">CAIXA:</b>'; ?> <?= $this->session->userdata('username'); ?>
