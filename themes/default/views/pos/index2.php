        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                <a href="<?= site_url(); ?>" class="logo">
                    <span class="logo-mini">REST ON</span>
                    <span class="logo-lg"><?= $Settings->site_name == 'POS ON' ? '<b>POS</b>' : '<img src="' . base_url('uploads/' . $Settings->logo) . '" alt="' . $Settings->site_name . '" />'; ?></span>
                </a>
            ...
            <div class="content-wrapper">
                            ...
                            <div id="lefttop" style="margin-bottom:3px;">
                                ...
                                <div class="form-group" style="margin-bottom:3px;">
                                    <div class="input-group" style="width: 100%">
                                        <select name="mesa" class="form-control" id="select_mesa">
                                            <option value="no"<?php echo empty($suspend) && empty($suspend["mesa"]) ? ' selected=""' : ''; ?>>-- Selecione a Mesa ou Comanda --</option>
                                            <?php
                                            $q = new Query();
                                            $q
                                                    ->select()
                                    ...
                                    <div class="col-xs-4" style="padding: 0;">
                                        <div class="btn-group-vertical btn-block">
                                            ...
                                            <button type="button" class="btn btn-danger btn-block btn-flat"
                                                    id="reset"><i class="fa fa-ban"></i> <?= lang('cancel'); ?></button>
                                        </div>
                ...
                <div id="box_right">
                    <div class="contents" id="right-col">
                        <div id="item-list">
                            <div class="items">
                                <div class="car-list-page car-list-3-columns padding-top-15">
                                    <?php foreach ($products as $p): ?>

                                        <?php foreach ($p as $index => $product): ?>
                                            <div class="box-vehicle car-list-item car-list-page-row-first-item">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 hidden">
                                <div class="form-group">
                                    ...
                                    <input name="balance" value="0" type="text" id="vbalance"
                                           class="pa form-control kb-pad amount"/>
                                </div>
                            </div>
                            <div class="col-xs-8">
