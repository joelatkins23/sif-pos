                            ...
                            <div id="botbuttons" class="col-xs-12 text-center">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4" style="padding: 0 5px;">
                                        <div class="btn-group-vertical btn-block">
                                            <a href="<?= site_url('sales/opened'); ?>" class="btn bg-purple btn-block btn-flat" id="ver_mesa"><i class="fa fa-th-large"></i> VD Guardada</a>
                                            <a href="<?= site_url('pos/view_bill'); ?>" target="_blank" class="btn bg-purple btn-block btn-flat" id="ver_mesa"><i class="fa fa-print"></i> Imp Pedido</a>
                                        </div>
                                    </div>
      <?php if ($garson) { ?>
            ...
            <div class="modal-body">
                <div class="row">
                            ...
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input name="amount[]" type="text"  required="required"
                                           class="pa form-control kb-pad amount" value=""  id="amount"/>
                                </div>
                                <div id="amount_error">
                    ...
                    <div class="col-xs-3 text-center">
                             <span style="font-size: 1.2em; font-weight: bold;"><?= lang('Conta Certa'); ?></span> 
