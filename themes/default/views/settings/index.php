                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       <div class="form-group">
                                            ...
                                            <?= form_input('ProductCompanyTaxID', $settings->ProductCompanyTaxID, 'class="form-control" id="ProductCompanyTaxID" required="required"  readonly'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                    ...
                                    <div class="form-group">
                                       <div class="form-group">
                                            ...
                                            <?= form_input('ProductID', $settings->ProductID, 'class="form-control" id="ProductID" required="required" readonly'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                       <div class="form-group">
                                            <?= lang("ProductVersion", 'ProductVersion'); ?>
                                            <?= form_input('ProductVersion', $settings->ProductVersion, 'class="form-control" id="ProductVersion" required="required" readonly'); ?>
                                        </div>
                                    </div>
